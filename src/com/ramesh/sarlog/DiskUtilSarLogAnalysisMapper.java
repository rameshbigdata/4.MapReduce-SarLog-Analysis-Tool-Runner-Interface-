...
import org.apache.hadoop.mapreduce.Mapper;
	...
	public class DiskUtilSarLogAnalysisMapper extends Mapper<LongWritable,Text,Text,DoubleWritable>
	{
		...
		{ 
			double memutil=0;
			   StringTokenizer stLine = new StringTokenizer(line.toString(), " "); 
				  ...
				  {
					  memutil=Double.parseDouble(elements.get(5).substring(0, elements.get(5).length()-1));
